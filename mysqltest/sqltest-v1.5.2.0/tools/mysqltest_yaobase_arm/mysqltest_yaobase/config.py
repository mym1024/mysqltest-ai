...
data_dir = '/home/fan/tools/yaobase/data/'         # $data_dir/{1..10} should exist
## comment line below if you want to provide custom schema and server conf template(see ob5's definition for another way)
## run: './deploy.py tpl.gensvrcfg' to generate a 'tpl' dir, edit tpl/yaoadminsvr.template... as you wish
tpl = load_dir_vars('tpl.4x')  # template of config file such as yaoadminsvr.conf/yaotxnsvr.conf...

ObCfg.all_hosts = '''192.168.16.106 192.168.16.107'''.split()
# list ip of test machines
ObCfg.default_hosts = '192.168.16.106'.split()
...
rs0_ip = '192.168.16.106'
ups1_ip = '192.168.16.106'
ups0_ip = '192.168.16.107'
cs0_ip = '192.168.16.106'
cs1_ip = '192.168.16.107'
ms0_ip = '192.168.16.106'
ms1_ip = '192.168.16.107'

ob1=YAOI()
ob1=YAOI(rs_port=31500,ups_port=31700,ms_port=31800,cs_port=31600,ups_inner_port=31770,mysql_port=31880,
rs0  = YaoAdminSvr(rs0_ip,paxos_num=2,cluster_num=1,name=1,sex=1,cluster_id=0),
ups1 = YaoTxnSvr(ups1_ip,paxos_id=0,cluster_id=0),
ups0 = YaoTxnSvr(ups0_ip,paxos_id=1,cluster_id=0),
cs0  = YaoDataSvr(cs0_ip,cluster_id=0),
cs1  = YaoDataSvr(cs1_ip,cluster_id=0),
ms1  = YaoSqlSvr(ms1_ip,cluster_id=0),
ms0  = YaoSqlSvr(ms0_ip,cluster_id=0))

# for duyr

#ob6=OBI()
#ob6=OBI( rs_port=2500,ups_port=2700,ms_port=2800,cs_port=2600,ups_inner_port=2770,mysql_port=2880,
#rs0 = YaoAdminSvr(rs0_ip),
#                    ups1 = YaoTxnSvr(ups1_ip),
#                     cs0 = YaoDataSvr(cs0_ip),
#                    cs1 = YaoDataSvr(cs1_ip),
#                   cs2 = YaoDataSvr(cs2_ip),
#                  ms0 = YaoSqlSvr(ms0_ip),
#                 ms1 = YaoSqlSvr(ms1_ip),)



# # config 'port', 'version' and 'schema' etc, no 'client'
# ## Note: if you set 'ver', yaotxnsvr/yaoadminsvr/... should be in dir 'bin.$ver'
...
# 		    lsyc_port = 3046,
#                     rs0 = YaoAdminSvr(rs0_ip),
#                     ups0 = YaoTxnSvr(ups0_ip, lsync_ip= ups0_ip, lsync_port = 3045),
