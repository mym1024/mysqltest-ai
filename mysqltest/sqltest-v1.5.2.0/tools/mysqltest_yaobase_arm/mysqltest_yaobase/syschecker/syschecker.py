...
def prepare(**self):
    ...
    rsync_ret = par_do(obi, 'yaodatasvr', 'rsync2', 'syschecker')
    gen_ret = par_do(obi, 'yaodatasvr', 'ssh_no_tty', '$dir/syschecker/gen.sh ${app_name}.schema $data_dir $sub_data_dir # ExceptionOnFail', timeout=300)
